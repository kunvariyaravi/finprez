    ...
    <div>
      ...
      <div>
        <p className={styles.responsiveParagraph}>
          ...
          on {formatDate(data.closedate)}. The allotment for the {data.title} is
          expected to be finalized on {formatDate(data.allotmentdate)}.{" "}
          {data.title} will list on {data.listingat} with tentative listing date
          fixed as {formatDate(data.listingdate)}. {data.title} price band is
          set at {data.price} per share. The minimum lot size for an application
        ...
        <table className={`${styles.table} ${styles.responsiveTable}`}>
          <tbody>
            ...
            <tr>
              <td className={styles.tableCell}>Offer for Sale issue Size:-</td>
        ...
        <table className={`${styles.table} ${styles.responsiveTable}`}>
          <tbody>
            <tr>
              ...
              <td className={styles.tableCell}>{formatDate(data.opendate)}</td>
            </tr>
            <tr>
              <td className={styles.tableCell}>Close Date:-</td>
              <td className={styles.tableCell}>{formatDate(data.closedate)}</td>
            </tr>
            <tr>
        ...
        <p className={styles.responsiveParagraph}>Website:- {data.registrarwebsite}</p>
        <h3 className={styles.responsiveParagraph}>{data.company} GMP :-</h3>
        <div>
