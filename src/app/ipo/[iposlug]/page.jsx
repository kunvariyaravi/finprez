...
// Async component to display a single IPO page with IPO details
const ipoPage = async ({ params }) => {
  const { iposlug } = params;

  // Fetch data for the specific IPO
  const data = await getData(iposlug);

  // Render the IPO page with IPO details
  return (
    <div>
      <div className={styles.content}>
        <div className={styles.post}>
          ...
          <div>
            ...
            <div
              className={styles.responsiveParagraph}
            ...
            <h2 className={styles.responsiveParagraph}>
              {data.company} GMP :-
            </h2>
            <div>
